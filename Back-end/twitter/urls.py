...
urlpatterns = [
    ...
    path('list-posts/<int:pk>', views.get_list_posts.as_view(), name='list-posts'),
    path('list-with-posts/<int:pk>', views.get_list_and_posts, name='list-with-posts'),
    ...
    path('post-with-comments/<int:pk>', views.get_post_with_comments, name='post-with-comments'),
    path('make-post', views.make_post.as_view(), name='make-post'),
    path('make-list', views.add_new_list.as_view(), name='make-list'),
    path('add-post-to-new-list/<int:pk>', views.add_post_to_new_list.as_view(), name='add-post-to-new-list'),
    path('add-post-to-list/<int:pk>', views.add_post_to_list.as_view(), name='add-post-to-list'),
